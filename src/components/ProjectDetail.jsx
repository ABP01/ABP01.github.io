...
const ProjectDetails = () => {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    // Supprimer tous les projets et ajouter ce portfolio comme unique projet
    const portfolioProject = {
      id: 1,
      Title: 'Mon Portfolio',
      Description: 'Ce site est mon portfolio personnel, développé avec React, Tailwind CSS, Vite et SweetAlert2. Il présente mes projets, compétences, certificats et permet de me contacter.',
      Img: '/Photo.JPG',
      Link: window.location.origin,
      Github: 'https://github.com/abp01',
      TechStack: ['React', 'Tailwind', 'Vite', 'SweetAlert2'],
      Features: [
        'Présentation interactive',
        'Affichage dynamique des certificats',
        'Ajout/suppression de projets en local',
        'Animations AOS',
        'Responsive design',
        'Contact par formulaire',
      ],
    };
    localStorage.setItem('projects', JSON.stringify([portfolioProject]));
