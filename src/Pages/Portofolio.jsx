...
import { certificates as localCertificates } from "../assets/certificates";
...
export default function FullWidthTabs() {
  ...
  // Charger les projets depuis le localStorage uniquement
  useEffect(() => {
    AOS.init({ once: false });
    setCertificates(localCertificates);
    // Laisser la liste des projets vide
    setProjects([]);
  }, []);
      ...
      <Box sx={{ width: "100%" }}>
        ...
        >
          <TabPanel value={value} index={0} dir={theme.direction}>
            <div className="container mx-auto flex justify-center items-center overflow-hidden min-h-[200px]">
              {displayedProjects.length === 0 ? (
                <div className="w-full text-center py-12">
                  <p className="text-lg md:text-xl text-slate-400 font-semibold">
            ...
            {projects.length > initialItems && displayedProjects.length > 0 && (
